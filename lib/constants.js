 ...
 * Load .env before reading process.env defaults (imports happen before script main()).
 */
...
export const DEFAULT_GAS = {
  ...
  // BSC gas floor is ~0.05 gwei now; 1 gwei mines reliably with huge headroom (was 3 = 60x overpay)
  bscGwei: Number(process.env.BSC_GAS_PRICE_GWEI || "1"),
