#!/usr/bin/env node
/** Approve BTCD for PGARouterV2 (step 4). */

import { parseUnits } from "ethers";
import { parseCommonFlags } from "../../lib/args.js";
import { approveBtcdForRouter } from "../../lib/fist/pgpRouter.js";
import { runPrivateBatch } from "../../lib/fist/runPrivateBatch.js";
import { FIST_PGP } from "../../lib/fist/constants.js";

function printHelp() {
  console.log(`usage: node scripts/fist/04-approveBTCD.js [options]
